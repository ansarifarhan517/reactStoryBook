...
babel-core@^6.26.0, babel-core@^6.8.0:
  version "6.26.3"
...
leaflet-linear-measurement@^0.0.1:
  version "0.0.1"
  resolved "https://registry.yarnpkg.com/leaflet-linear-measurement/-/leaflet-linear-measurement-0.0.1.tgz#3b56bc7d6199df434b583626d794cfd239997f5a"
  dependencies:
    gulp "^3.9.0"
    gulp-clean "^0.3.1"
    gulp-uglify "^1.2.0"
...
readable-stream@^2.0.1, readable-stream@^2.0.2, readable-stream@^2.0.5, readable-stream@^2.0.6, readable-stream@^2.1.5, readable-stream@^2.2.2, readable-stream@^2.3.6:
  version "2.3.6"
