...
var ReactLeafletGoogleLayer = /** @class */ (function (_super) {
    ...
    function ReactLeafletGoogleLayer() {
        ...
        _this.addGoogleLayer = function (name, options) {
            _this.leafletElement.addGoogleLayer(name, options);
        };
        _this.removeGoogleLayer = function (name) {
            _this.leafletElement.removeGoogleLayer(name);
        };
        return _this;
    }
    ReactLeafletGoogleLayer.prototype.createLeafletElement = function (props) {
        var _this = this;
        var useGoogMapsLoader = props.useGoogMapsLoader, googleMapsLoaderConf = props.googleMapsLoaderConf, googleMapsAddLayers = props.googleMapsAddLayers, leaflet = props.leaflet, googleMutantProps = __rest(props, ["useGoogMapsLoader", "googleMapsLoaderConf", "googleMapsAddLayers", "leaflet"]);
        ...
        if (googleMapsAddLayers) {
            googleMapsAddLayers.forEach(function (layer) {
                _this.leafletElement.addGoogleLayer(layer.name, layer.options);
            });
        }
