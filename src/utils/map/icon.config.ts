...
const markerIcons = {
    ...
    simpleBlue: {
        html: '<div><img src="images/maps/blue.svg"  alt="" tabindex="0" style=" z-index: 100164;"/></div>',
        iconSize: [10, 10],
        iconAnchor: [5, 20]
    },
    simpleRed: {
        html: '<div><img src="images/maps/red.svg"  alt="" tabindex="0" style=" z-index: 100164;"/></div>',
        iconSize: [10, 10],
        iconAnchor: [5, 20]
    },
    simpleYellow: {
        html: '<div><img src="images/maps/yellow.svg"  alt="" tabindex="0" style=" z-index: 100164;"/></div>',
        iconSize: [10, 10],
        iconAnchor: [5, 20]
    },
    locationSearch: {
        html: '<div><img src="images/maps/Bigmarker_red.svg"  alt="" tabindex="0" style=" z-index: 100164;"/></div>',
    ...
    PICKUP_CANCELLED: {
        html:
            '<div style="height:25px;width:25px;background:grey;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">P</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    PICKUP_DELIVERED: {
    ...
    PICKUP_INTRANSIT: {
        html:
            '<div style="height:25px;width:25px;background:#f5a837;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">P</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    PICKUP_NOTDELIVERED: {
    ...
    PICKUP_NOTDISPATCHED: {
        html:
            '<div style="height:25px;width:25px;background:#ef5548;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">P</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    PICKUP_NOTPICKEDUP: {
        html:
            '<div style="height:25px;width:25px;background:white;color:#000;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">P</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    PICKUP_PICKEDUP: {
        html:
            '<div style="height:25px;width:25px;background:#6fc64f;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">P</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    DELIVER_CANCELLED: {
        html:
            '<div style="height:25px;width:25px;background:grey;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">D</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    DELIVER_DELIVERED: {
        html:
            '<div style="height:25px;width:25px;background:#5698d3;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">D</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    DELIVER_INTRANSIT: {
        html:
            '<div style="height:25px;width:25px;background:#f5a837;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">D</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    DELIVER_NOTDELIVERED: {
        html:
            '<div style="height:25px;width:25px;background:grey;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">D</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    DELIVER_NOTDISPATCHED: {
        html:
            '<div style="height:25px;width:25px;background:#ef5548;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">D</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    DELIVER_NOTPICKEDUP: {
        html:
            '<div style="height:25px;width:25px;background:white;color:#000;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">D</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    DELIVER_PICKEDUP: {
        html:
            '<div style="height:25px;width:25px;background:#6fc64f;color:white;text-align:center;line-height:25px;font-size:11px;border-radius:50%;transform: translate(-33%,-33%);">D</div>',
        iconSize: [10, 10],
        iconAnchor: [5, 5]
    },
    pickupLocation: {
