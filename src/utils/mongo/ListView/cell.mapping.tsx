...
import { ALL_ADDRESSES_LIST_MAPPINGS } from "../../../modules/customer-master/address/pages/list-view/config/cell-mappings";
import { ALL_ADDRESSES_MAP_MAPPINGS } from "../../../modules/customer-master/address/components/address-map/config/cell-mappings";
...
const CELL_MAPPING: ICellMapping = {
  ...
  all_addresses_map: ALL_ADDRESSES_MAP_MAPPINGS,
  all_addresses: ALL_ADDRESSES_LIST_MAPPINGS,
