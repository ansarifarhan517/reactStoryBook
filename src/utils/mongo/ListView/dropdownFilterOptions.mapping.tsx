...
import ALL_ADDRESSES_DROPDOWN_FILTER_OPTIONS_MAPPING from "../../../modules/customer-master/address/pages/list-view/config/dropdown-filter-mappings";
import ALL_ADDRESSES_MAP_DROPDOWN_FILTER_OPTIONS_MAPPING from "../../../modules/customer-master/address/components/address-map/config/dropdown-filter-mappings";
...
const DROPDOWN_FILTER_OPTIONS_MAPPING = {
  ...
  all_addresses: ALL_ADDRESSES_DROPDOWN_FILTER_OPTIONS_MAPPING,
  all_addresses_map: ALL_ADDRESSES_MAP_DROPDOWN_FILTER_OPTIONS_MAPPING,
