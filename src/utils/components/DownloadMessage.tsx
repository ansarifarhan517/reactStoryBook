...
const DownloadMessage = ({ showInfoModal, onToggle }: IDownloadMessage) => {
        ...
        <>
            <Modal
                ...
                children={{
                    ...
                    content: (
                        <div style={{ fontSize: 14, color: '#000' }}>{dynamicLabels.downloadInfoMsg || "Thank you! Your report is being generated and will be  downloaded soon."}</div>
                    ),
                    footer: (
                        <Box
