      ...
      templates: [
        {
          ...
          icon: "",
          videoUrl:
            "https://www.youtube.com/embed/7ZeIhhiYaj8?playlist=7ZeIhhiYaj8&loop=1",
          buttons: [
            {
              label: "Try Now",
              url: "/product/#/settings/organizationRoles",
              labelKey: "TRY_NOW",
            },
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2021/03/19/user-and-access-management/",
              labelKey: "LEARN_MORE",
            },
          ],
        },
      ...
      templates: [
        {
          ...
          icon: "",
          videoUrl:
            "https://www.youtube.com/embed/fp5FxSOLJsA?playlist=fp5FxSOLJsA&loop=1",
          buttons: [
            {
              label: "Try Now",
              url: "/product/#/settings/clientBranchManagement",
              labelKey: "TRY_NOW",
            },
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2021/04/05/branch-configuration/",
              labelKey: "LEARN_MORE",
            },
            {
              label: "API Details",
              url: "/product/#/developersPortal#hub",
          ...
          templates: [
            {
              ...
              description: `<div>
                  ...
                  <ul>
                  <li>Filling out the Add Delivery Associate form</li>
                  <li>Uploading an Excel file containing delivery associates’ details</li>
                  <li>Using the Create Delivery Associate API</li>
                </div>`,
              descriptionKey: "DA_CREATION_DESCRIPTION",
              title: "",
              icon: "",
              videoUrl:
                "https://www.youtube.com/embed/VbtEEDtMs_E?playlist=VbtEEDtMs_E&loop=1",
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/deliverymedium/",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2018/01/11/add-new-delivery-associate/",
                  labelKey: "LEARN_MORE",
                },
                {
                  label: "API Details",
                  url: "/product/#/developersPortal#delivery-associate-2",
                  labelKey: "API_DETAILS",
                },
              ],
            },
          ...
          templates: [
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/fleetManagement",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2019/02/01/activate-dm-driver-app/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
            {
              ...
              buttons: [
                ...
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2021/09/15/fleet-configuration/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
          ...
          templates: [
            {
              ...
              icon: "",
              videoUrl:
                "https://www.youtube.com/embed/QRz7jWq85dg?playlist=QRz7jWq85dg&loop=1",
              buttons: [
                {
                  label: "Try Now",
                ...
                {
                  label: "API Details",
                  url: "/product/#/developersPortal#order-2",
                  labelKey: "API_DETAILS",
                },
              ],
            },
          ...
          templates: [
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/orderLifeCycleManagement",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2021/09/29/order-lifecycle-management/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/orderManagement",
                  labelKey: "TRY_NOW",
                },
              ],
            },
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/awbLabelConfiguration",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2021/03/23/awb-label-template-configuration/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
            {
              "type": "Image",
              "description": "<div><p>Inscanning (scanning orders as they enter a hub) and outscanning (scanning orders as they exit a hub) ensure an improved order sorting process, maintain accountability, and reduce pilferage. When you outscan orders with the same next destination together, you automatically create a Manifest ID for them. A Manifest ID is used to identify a manifest, i.e., a bag/package containing orders that are moved together.</p></div>",
              "descriptionKey": "SCAN_DESCRIPTION",
              "title": "Scan Orders",
              "titleKey": "SCAN_TITLE",
              "icon": "",
              "videoUrl": "",
              "buttons": [
                {
                  "label": "Try Now",
                  "url": "/product/#/scannedorders",
                  "labelKey": "TRY_NOW",
                },
                {
                  "label": "Learn More",
                  "url": "https://support.loginextsolutions.com/index.php/2018/03/06/inscan-orders/",
                  "labelKey": "LEARN_MORE",
                },
                {
                  "label": "API Details",
                  "url": "/product/#/developersPortal#manifest",
                  "labelKey": "API_DETAILS",
                },
              ],
            },
          ...
          templates: [
            {
              ...
              icon: "",
              videoUrl:
                "https://www.youtube.com/embed/N9puxyc89Ck?playlist=N9puxyc89Ck&loop=1",
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/Default%20Assignment?subModule=PROFILE",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2019/03/25/auto-assignment-properties/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
          ...
          templates: [
            {
              ...
              icon: "",
              videoUrl:
                "https://www.youtube.com/embed/kDyPUVvihpY?playlist=kDyPUVvihpY&loop=1",
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/live",
                ...
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2018/12/03/auto-assigning-orders-to-trips/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
      ...
      templates: [
        {
          ...
          icon: "",
          videoUrl:
            "https://www.youtube.com/embed/77YLJVLmCmM?playlist=77YLJVLmCmM&loop=1",
          buttons: [
            {
              label: "Try Now",
              url: "/product/#/settings/planningPreferences",
              labelKey: "TRY_NOW",
            },
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2018/01/18/route-planning-properties-2/ ",
              labelKey: "LEARN_MORE",
            },
            {
              label: "API Details",
              url: "/product/#/developersPortal#route-planning",
              labelKey: "API_DETAIL",
            },
          ],
        },
          ...
          templates: [
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/Template%20Configuration?subModule=BRANDING_PROFILE",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2021/03/01/branding-profile-configuration/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
          ...
          templates: [
            {
              ...
              description: `<div>
                  ...
                  <p>
                  You can use CARRIER Alert Profiles to configure alerts for the orders associated with your shippers and Hub Alert Profiles to configure alerts for the orders associated with your hubs. If an order doesn’t have any Hub/Shipper Alert Profile associated with it, the alert settings configured in the Organization Alert Profile apply. </p>
                </div>`,
              descriptionKey: "CUSTOMER_ALERTS_DESCRIPTION",
              titleKey: "CUSTOMER_ALERTS_TITLE",
              icon: "",
              videoUrl: "https://www.youtube.com/embed/y04_Ln3MNBo?playlist=y04_Ln3MNBo&loop=1",
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/alertProfiles?subModule=ORGANIZATION",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2021/04/20/alert-profiles/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
      ...
      templates: [
        {
          ...
          title: "",
          icon: "",
          videoUrl: "https://www.youtube.com/embed/HjqJ7_c7cKs?playlist=HjqJ7_c7cKs&loop=1",
          buttons: [
            {
              label: "Try Now",
              url: "/product/#/settings/reportScheduling",
              labelKey: "TRY_NOW",
            },
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2020/07/05/overall-summary-analytics/",
              labelKey: "LEARN_MORE",
            },
          ],
        },
          ...
          templates: [
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/organizationwebhooksprofile",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2021/03/11/webhook-profile-configuration/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
          ...
          templates: [
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/apiTokens",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "API Details",
                  url: "/product/#/developersPortal#authenticate",
                  labelKey: "API_DETAILS",
                },
              ],
            },
            {
              ...
              buttons: [
                {
                  label: "Try Now",
                  url: "/product/#/settings/integrationMarketplace",
                  labelKey: "TRY_NOW",
                },
                {
                  label: "Learn More",
                  url: "https://support.loginextsolutions.com/index.php/2019/06/07/integrations-marketplace/",
                  labelKey: "LEARN_MORE",
                },
              ],
            },
      ...
      templates: [
        {
          ...
          description: `<div>
            ...
            <ul>
              <li>
                Filling out the Add Shipper form
              </li>
              <li>
                Uploading an Excel file containing shippers’ details
              </li>
              <li>
                Using the Create Shipper API
              </li>
              <li>
                Approving a Shipper Request
              </li>
            </ul>
          </div>`,
          ...
          buttons: [
            ...
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2020/06/29/add-shipper/",
              labelKey: "LEARN_MORE",
            },
            {
              label: "API Details",
              url: "/product/#/developersPortal#shipper-2",
              labelKey: "API_DETAILS",
            },
          ],
        },
        {
          ...
          buttons: [
            {
              label: "Try Now",
              url: "/product/#/serviceAreaMaster",
              labelKey: "TRY_NOW",
            },
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2020/06/15/service-area-profile/",
              labelKey: "LEARN_MORE",
            },
            {
              label: "API Details",
              url: "/product/#/developersPortal#shipper-serviceability",
              labelKey: "API_DETAILS",
            },
          ],
        },
      ...
      templates: [
        {
          type: "Image",
          description: `<div>
            <p>A carrier is a third-party logistics provider that fulfills your order transportation requirements. You can add carriers in 2 ways:</p>
            <ul>
              <li>
             Filling out the Add Carrier form
              </li>
              <li>
              Uploading an Excel file containing carriers’ details
              </li>
             
            </ul>
          </div>`,
          descriptionKey: "ONBOARD_CARRIER_DESCRIPTION",
          titleKey: "ONBOARD_CARRIER_TITLE",
          ...
          buttons: [
            {
              label: "Try Now",
              url: "/product/#/carrierManagement",
              labelKey: "TRY_NOW",
            },
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2019/02/21/add-carriers/",
              labelKey: "LEARN_MORE",
            },
            {
              label: "API Details",
              url: "/product/#/developersPortal#carrier-assignment",
              labelKey: "API_DETAILS",
            },
          ],
        },
        {
          type: "Image",
          description: `<div>
            <p>The Contract Master module lets you add the details of contracts with your carriers. Within a contract, you can specify the type of fleet that a carrier would be providing you along with the rates per fleet type. You can also configure Rate Profiles to calculate the cost of order fulfillment by carriers/delivery associates. Configure multiple cost parameters within a Rate Profile, link it with a carrier/delivery associate, and the same parameters would apply to all the orders that the carrier/delivery associate fulfills.</p>
          </div>`,
          descriptionKey: "SETUP_LOCATION_DESCRIPTION",
          title: "Manage carrier contracts and rates",
          titleKey: "SETUP_LOCATION_TITLE",
          icon: "",
          videoUrl: "",
          buttons: [
            {
              label: "Try Now",
              url: "/product/#/rateContractMaster/",
              labelKey: "TRY_NOW",
            },
            {
              label: "Learn More",
              url: "https://support.loginextsolutions.com/index.php/2019/02/21/contracts/",
              labelKey: "LEARN_MORE",
            },
          ],
        },
