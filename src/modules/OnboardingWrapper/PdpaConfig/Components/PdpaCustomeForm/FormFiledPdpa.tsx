...
import { FormContainer, FormFieldWapper, SectionHeaderContainer } from "../../../CustomForms/CustomFormsStyledComponents";
...
const FormFieldPdpa = (props: IFormFieldsProps) => {
    ...
    return (
        <FormContainer key={sectionName}>
            ...
            <SectionHeaderContainer><SectionHeader headerTitle={dynamicLabels[sectionName] ? dynamicLabels[sectionName] : sectionName} /></SectionHeaderContainer>
