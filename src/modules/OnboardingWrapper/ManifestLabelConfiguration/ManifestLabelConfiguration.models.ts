...
export interface IManifestLabelConfigTagGroup {
    key: string
    value: number
    label: string
}

export interface IManifestLabelConfigTag {
...
export interface IManifestLabelConfigTagsAPIResponse {
    id: string
    tagGroupMappingList: IManifestLabelConfigTagGroup[]
    dynamicTagKeys: IManifestLabelConfigTag[]
}
...
export interface IManifestTemplateFormData {
    templateId: number
    templateName: string
    templateDesc: string
    orderHTML: string
...
export const orderCrateDetails = [{
    ...
    dateAndTimeOfPrintingManifest: '24/09/2021 12:43PM',
    date:'24/09/2021 ',
    ...
    originBranchName: "New York Main Hub",
    originBranchCode: "New York Main Hub",
    nextBranchCode: "CHICAGO HUB",
    destBranchName: 'CHICAGO HUB',
    weight:'45.6',
    volume:'100.1',
    crates:'20',
    orders:'10',
