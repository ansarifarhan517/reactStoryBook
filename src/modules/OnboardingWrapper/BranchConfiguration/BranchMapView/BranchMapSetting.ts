import { dynamicLabelMapping } from '../../../../utils/components/Map/MapHelper';

export const BranchMapSetting = (dynamicLabels: Record<string, string>) => ({
    'Map Mode': {
        title: 'Map Mode',
        type: 'radio',
        option: [
    ...
    Miscellaneous: {
        ...
        option: [
            ...
            },
            {
                ...
                selected: true,
                label:  dynamicLabelMapping(dynamicLabels)?.locationSearch,
                enablingToasterMessage:  dynamicLabelMapping(dynamicLabels)?.enablingLocationSearch,
                disablingToasterMessage: dynamicLabelMapping(dynamicLabels)?.disablingLocationSearch,
                image:
