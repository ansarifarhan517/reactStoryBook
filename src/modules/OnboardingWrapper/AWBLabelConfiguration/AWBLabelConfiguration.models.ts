...
export interface IRowData {
    awbTemplateName: string
    awbTemplateDesc: string
    isActiveFl: Boolean
...
export interface IAWBListDataPayload {
...
export interface IAwbLabelConfigTagGroup {
    key: string
    value: number
    label: string
}

export interface IAwbLabelConfigTag {
...
export interface IAwbLabelConfigTagsAPIResponse {
    id: string
    tagGroupMappingList: IAwbLabelConfigTagGroup[]
    dynamicTagKeys: IAwbLabelConfigTag[]
}
...
export interface IAwbTemplateFormData {
    awbTemplateId: number
    awbTemplateName: string
    awbTemplateDesc: string
    orderHTML: string
    ...
    crates: [
        {
            ...
            crateLength: '20 in',
            crateName: "Crate 1",
            crateType: "Perishable",
            crateVolume: '50 l',
            crateWeight: '50 lb',
            createdByUserId: 31690,
            createdOnDt: "15, Jun 2021 07:23 PM",
            id: 30618667,
            isActiveFl: true,
            isDeleteFl: "N",
            ...
            loadedUnits: 1,
            noOfUnits: 10,
            orderNo: "DELIVERorder",
            shipmentDetailsId: 22121274,
            shipmentMappingId: 30618667,
            crateTemperatureCategory: "Ambient",
            crateMinTemperature: "0 c",
            crateMaxTemperature: "2 c",
            shipmentlineitems: [
                {
                    createdOnDt: "15, Jun 2021 07:23 PM",
                    id: 14693718,
                    ...
                    maxTemperature: "0 C",
                    minTemperature: "2 C",
                    shipmentLineItemId: 14693718,
                    statusCd: "UNLOADED",
                    temperatureCategory: "Ambient",
                    unloadedQuantity: 1,
                    updatedByUserId: 31690,
                    updatedOnDt: "15, Jun 2021 07:25 PM",
                },
                {
                    createdOnDt: "15, Jun 2021 07:23 PM",
                    id: 14693719,
            ...
            statusCd: "UNLOADED",
            totalItemsVolume: 524.3864,
            totalItemsWeight: 9.0718,
            unloadedUnits: 1,
            updatedByUserId: 31690,
            updatedOnDt: 1623765351000,
