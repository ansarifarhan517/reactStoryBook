...
const blk = 'social-share'

const SocialShare = ({ url = '', dataAutoId }: socialShareProps) => {
  ...
  return (
    <div className={blk}>
      <div className={bemClass([blk, 'panel', { show }])}>
        <a
          href={`http://www.facebook.com/sharer.php?u=https://www.loginextsolutions.com${url}`}
          target="_blank"
          className={bemClass([blk, 'social-link'])}
        ...
        <a
          href={`https://twitter.com/share?url=https://www.loginextsolutions.com${url}`}
          target="_blank"
          className={bemClass([blk, 'social-link'])}
        ...
        <a
          href={`http://www.linkedin.com/shareArticle?mini=true&url=https://www.loginextsolutions.com${url}`}
          target="_blank"
          className={bemClass([blk, 'social-link'])}
      ...
      <button
        ...
        className={bemClass([blk, 'button', { show }])}
      >
        <Image
          src={show ? iconClose : iconShare}
          alt="Share"
          className={bemClass([blk, 'icon'])}
          data-auto-id={show ? `${dataAutoId}_close` : dataAutoId}
        />
      </button>
    </div>
  )
