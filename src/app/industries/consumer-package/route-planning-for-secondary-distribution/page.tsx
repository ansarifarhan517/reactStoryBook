...
const url = 'https://www.loginextsolutions.com/industries/consumer-package/route-planning-for-secondary-distribution'
...
const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/industries/retail-and-ecommerce/route-planning-for-secondary-distribution'
  }
}
