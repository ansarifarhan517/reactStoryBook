...
const NumberFormField = ({
  ...
  return <><TextInput
    ...
    id={name}
    error={error || requiredError || errors[name] || meta["customValidationError"]}
    errorMessage={(requiredError ? `${meta.label} is mandatory` : error ? error : meta.validation?.[errorTypeMapping[errors[name]?.type]]?.message) || meta["customValidationErrorMessage"]}
